...
Launches training on our own dataset (5 categories, 100k tweets)
...
if __name__ == '__main__': 
    ...
    SAVE_FILENAME='./saved_model_w/our_dataset.pth'
    LOGS='../data/logs_our_dataset.npy'
    # To load model 
    SAVED_MODEL_PATH ='./saved_model_w/our_dataset.pth'
    ...
    pickle.dump(loaders.dataset.words_to_ids,open("./saved_model_w/vocabulary_our_d.pickle","wb"))
    glove_matrix = loaders.get_glove_matrix('data/glove')
    pickle.dump(glove_matrix,open("./saved_model_w/glove_matrix_our_d.pickle","wb"))
